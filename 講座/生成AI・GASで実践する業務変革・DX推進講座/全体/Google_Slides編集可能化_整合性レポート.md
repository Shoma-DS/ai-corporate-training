...
| ---: | --- | ---: | ---: | --- | --- |
| 1 | 業務DXの基礎とGoogle Workspace活用設計 | 38 | 6 | `Googleスライド編集用アウトライン.md`, `図解パーツ生成プロンプト.md` | なし |
| 2 | 業務データ基盤の設計 | 45 | 5 | `Googleスライド編集用アウトライン.md`, `図解パーツ生成プロンプト.md` | なし |
| 3 | GASによる業務プロセス自動化 | 50 | 6 | `Googleスライド編集用アウトライン.md`, `図解パーツ生成プロンプト.md` | なし |
| 4 | Gem/Geminiを使った文書作成・分類・要約 | 46 | 6 | `Googleスライド編集用アウトライン.md`, `図解パーツ生成プロンプト.md` | なし |
| 5 | AI/GAS自動化の要件定義・運用設計 | 46 | 6 | `Googleスライド編集用アウトライン.md`, `図解パーツ生成プロンプト.md` | なし |
| 6 | AI業務効率化プロジェクト提案書の作成 | 47 | 7 | `Googleスライド編集用アウトライン.md`, `図解パーツ生成プロンプト.md` | なし |
